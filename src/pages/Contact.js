...
const quickLinks = [
  {
    ...
    value: "truelineresearchteam@gmail.com",
    href: "mailto:truelineresearchteam@gmail.com",
  },
  {
...
const branchLocations = [
  ...
  },
  {
    ...
    address: [
      ...
      "Ernakulam, Kerala 682039 (Landmark: Cake Hut Shop)",
    ],
    mapsHref:
    ...
    <div className="bg-[#f5f8fb] text-[#0f172a]">
        ...
        <div className="container relative mx-auto px-6">
          <div className="mx-auto max-w-4xl text-center space-y-6">
            ...
            <p className="text-lg md:text-xl text-white/80 leading-relaxed">
              Share a quick brief and we'll align the right research, IP, or accreditation pod for you. Most conversations move from inbox to kickoff within a week.
            </p>
          ...
          <div className="grid gap-12 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.3fr)] items-start">
            <div className="space-y-6">
              <h2 className="text-3xl font-bold text-[#0f172a]">
                Tell us about your next milestone
              </h2>
              <p className="text-slate-600 leading-relaxed">
                Whether you're preparing a manuscript submission, mapping an IP sprint, or planning an accreditation cycle, one note is enough to get started. We'll route it to the specialist pod and follow up with a short call if needed.
              </p>
      ...
      <section className="py-16 bg-[#f5f8fb] text-[#0f172a]">
        <div className="container mx-auto px-6 space-y-6 text-center">
          <h2 className="text-2xl font-semibold">Prefer to talk first?</h2>
          <p className="mx-auto max-w-2xl text-slate-600 leading-relaxed">
            We host weekly discovery calls covering manuscripts, IP, and research office transformations. Drop us a line and we'll share available slots, or call the desk directly for urgent requests.
          </p>
          <div className="flex flex-wrap justify-center gap-4 text-sm font-semibold uppercase tracking-[0.28em] text-slate-500">
            <span>Confidential by default</span>
            <span>Pods across India & GCC</span>
            <span>Hybrid & onsite support</span>
          </div>
        </div>
      </section>
